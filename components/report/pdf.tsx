...
import { camelToPascalWithSpaces } from "@/utils/func";
import {
  Document,
  PDFDownloadLink,
  PDFViewer,
...
const ReportPdfDownloader = ({
  ...
  return (
    ...
    >
      {({ loading }) =>
        loading ? (
          <TextButton className="bg-red-500">Loading document...</TextButton>
        ) : (
          <TextButton className="bg-green-500">Download</TextButton>
        )
      }
    </PDFDownloadLink>
  );
