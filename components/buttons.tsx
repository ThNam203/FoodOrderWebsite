  ...
  ({ className, content, iconBefore, iconAfter, ...props }, ref) => {
    return (
      <button
        ref={ref}
        className={cn(
          "w-full px-2 py-3 bg-primary text-white hover:bg-secondary disabled:bg-primary/60 rounded-md text-md font-bold flex flex-row items-center justify-center cursor-pointer disabled:cursor-default",
          className
        )}
        {...props}
      >
